...
const PLANOS = [
  {
    ...
    preco: 0,
    periodo: "",
    orcamentos: "3 orçamentos",
    descricao: "Para experimentar sem compromisso.",
    destaque: false,
    ribbon: null,
    features: [
      "3 orçamentos incluídos",
      "PDF profissional",
      "Gestão de clientes",
  ...
  },
  {
    ...
    descricao: "Para negócios que emitem muito.",
    destaque: false,
    ribbon: null,
    features: [
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Sim. O plano Ilimitado não tem contrato mínimo. Os packs são compra única — pagas uma vez, usas sem prazo.",
  },
  {
